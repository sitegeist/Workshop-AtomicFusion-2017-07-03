...
//
var components = {
	'Organism/Header': _Header2.default
};
...
var bootstrap = function bootstrap() {
	return [].slice.call(document.querySelectorAll('[data-component]')).forEach(function (el) {
		var componentIdentifier = el.getAttribute('data-component');
		var component = components[componentIdentifier];
...
exports.default = function (el) {
	var topNavigationWrap = document.querySelector('.top-navigation-wrap');
	var bodyPadding = topNavigationWrap ? topNavigationWrap.clientHeight : 20;
	...
	window.addEventListener('scroll', (0, _lodash2.default)(function () {
		var shouldBeScrolling = window.scrollY > 0;
		var isScrolling = document.body.classList.contains('scrolling');
